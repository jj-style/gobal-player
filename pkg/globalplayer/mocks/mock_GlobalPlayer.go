...
func (_m *MockGlobalPlayer) GetLive() ([]*models.LiveStation, error) {
	ret := _m.Called()
	...
	var r1 error
	if rf, ok := ret.Get(0).(func() ([]*models.LiveStation, error)); ok {
		return rf()
	}
	if rf, ok := ret.Get(0).(func() []*models.LiveStation); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockGlobalPlayer_GetLive_Call) Return(_a0 []*models.LiveStation, _a1 error) *MockGlobalPlayer_GetLive_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockGlobalPlayer_GetLive_Call) RunAndReturn(run func() ([]*models.LiveStation, error)) *MockGlobalPlayer_GetLive_Call {
	_c.Call.Return(run)
	return _c
}
