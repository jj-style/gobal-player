...
import (
	...
	feeds "github.com/jj-style/feeds"
...
// GetLive provides a mock function with given fields: _a0
func (_m *MockUseCase) GetLive(_a0 context.Context) ([]*models.LiveStation, error) {
	ret := _m.Called(_a0)
	...
	var r0 []*models.LiveStation
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) ([]*models.LiveStation, error)); ok {
		return rf(_a0)
	}
	if rf, ok := ret.Get(0).(func(context.Context) []*models.LiveStation); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*models.LiveStation)
		}
	}
...
// MockUseCase_GetLive_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetLive'
type MockUseCase_GetLive_Call struct {
	*mock.Call
}

// GetLive is a helper method to define mock.On call
//   - _a0 context.Context
func (_e *MockUseCase_Expecter) GetLive(_a0 interface{}) *MockUseCase_GetLive_Call {
	return &MockUseCase_GetLive_Call{Call: _e.mock.On("GetLive", _a0)}
}

func (_c *MockUseCase_GetLive_Call) Run(run func(_a0 context.Context)) *MockUseCase_GetLive_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockUseCase_GetLive_Call) Return(_a0 []*models.LiveStation, _a1 error) *MockUseCase_GetLive_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockUseCase_GetLive_Call) RunAndReturn(run func(context.Context) ([]*models.LiveStation, error)) *MockUseCase_GetLive_Call {
	_c.Call.Return(run)
	return _c
}
